...
XS(XS_Storable__Cxt_DESTROY)
{
    ...
    {
	SV *	self = ST(0);
#line 6351 "Storable.xs"
	stcxt_t *cxt = (stcxt_t *)SvPVX(SvRV(self));
#line 6378 "Storable.c"
#line 6353 "Storable.xs"
	if (kbuf)
		Safefree(kbuf);
...
XS(XS_Storable_pstore)
{
    ...
    dXSI32;
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", GvNAME(CvGV(cv)), "f, obj");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
XS(XS_Storable_mstore)
{
    ...
    dXSI32;
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", GvNAME(CvGV(cv)), "obj");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV *	obj = ST(0);
	SV *	RETVAL;
#line 6427 "Storable.xs"
  if (!do_store(aTHX_ (PerlIO*) 0, obj, 0, ix, &RETVAL))
    RETVAL = &PL_sv_undef;
#line 6462 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(XS_Storable_last_op_in_netorder)
{
    ...
    {
	bool	RETVAL;
#line 6459 "Storable.xs"
  RETVAL = !!last_op_in_netorder(aTHX);
#line 6557 "Storable.c"
	ST(0) = boolSV(RETVAL);
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS(boot_Storable)
{
...

    {
        ...
        cv = newXS("Storable::net_pstore", XS_Storable_pstore, file);
        XSANY.any_i32 = 1 ;
        sv_setpv((SV*)cv, "$$") ;
        cv = newXS("Storable::pstore", XS_Storable_pstore, file);
        XSANY.any_i32 = 0 ;
        sv_setpv((SV*)cv, "$$") ;
        cv = newXS("Storable::mstore", XS_Storable_mstore, file);
        XSANY.any_i32 = 0 ;
        sv_setpv((SV*)cv, "$") ;
        cv = newXS("Storable::net_mstore", XS_Storable_mstore, file);
        XSANY.any_i32 = 1 ;
        sv_setpv((SV*)cv, "$") ;
        ...
        cv = newXS("Storable::is_storing", XS_Storable_is_storing, file);
        XSANY.any_i32 = ST_STORE ;
        sv_setpv((SV*)cv, "") ;
        cv = newXS("Storable::is_retrieving", XS_Storable_is_storing, file);
